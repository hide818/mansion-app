...
const SECTIONS = [
  {
    ...
    steps: [
      ...
      },
      {
        step: '2',
        title: '物件を登録する',
        body: '左メニューの「物件」から物件を追加します。物件名・住所・戸数を入力するだけで登録完了です。既存のExcelデータがある場合はCSVインポート機能を使うと一括登録できます（後述）。',
      },
      {
        step: '3',
        title: 'スタッフを招待する（管理者のみ）',
        body: '左メニューの「設定」→「ユーザー管理」からスタッフのメールアドレスを入力して招待できます。招待されたスタッフはメールのリンクからアカウントを作成します。',
      },
      {
        step: '4',
        title: 'タスクを登録して使い始める',
  ...
  },
  {
    id: 'property',
    title: '物件の登録方法',
    subtitle: '手動登録とCSV一括登録の2つの方法があります',
    ...
    steps: [
      {
        step: '手動登録',
        title: '左メニュー「物件」→「新規追加」',
        body: '物件名・住所・戸数を入力して保存します。1棟ずつ登録したい場合や、少数の場合はこちらが簡単です。',
      },
      {
        step: 'CSV登録',
        title: '左メニュー「データインポート」→「物件」タブ',
        body: 'テンプレートCSVをダウンロードし、Excelで物件情報を入力してアップロードします。10棟以上ある場合は一括登録が便利です。',
        note: 'CSVはExcelで「CSV UTF-8（コンマ区切り）」形式で保存してください。',
      },
      {
        step: '確認',
        title: '物件一覧で登録内容を確認',
        body: '左メニュー「物件」で登録した物件が一覧表示されます。物件名をクリックすると詳細・案件・居住者情報が確認できます。',
      },
    ],
  },
  {
    ...
    steps: [
      {
        step: '1',
        title: 'テンプレートをダウンロード',
        body: '左メニュー「データインポート」を開き、「居住者」または「法定点検」タブを選択します。「テンプレートをダウンロード」ボタンを押してExcelファイルを取得してください。',
      },
      {
        step: '2',
        title: 'Excelにデータを入力',
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: '2',
        title: 'AI議事録を開く',
        body: 'ダッシュボードの「AI議事録を作成」ボタン、または左メニューの「AI議事録」をクリックします。',
      },
      {
        step: '3',
        title: '物件・会議情報を入力',
      ...
      {
        step: '5',
        title: '内容を確認・修正してPDF出力',
        body: '生成された議事録を確認し、必要に応じて修正します。「PDF出力」ボタンで印刷・保存できます。抽出されたタスクは「案件に登録」ボタンで自動登録できます。',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        step: '1',
        title: '案件を作成する',
        body: '物件を選択→「案件」タブ→「新規案件」を作成します。件名・種別・担当者・優先度を設定してください。',
      },
      {
        step: '2',
        title: 'タスクを追加する',
      ...
      },
      {
        step: '確認',
        title: '全案件を一覧で把握',
        body: '左メニュー「案件」から全物件の案件を横断的に確認できます。期限切れ・停滞中の案件は赤・黄色でハイライトされます。',
      },
    ],
  },
  {
    ...
    steps: [
      {
        step: '1',
        title: 'AI引き継ぎ書を開く',
        body: 'ダッシュボードの「AI引き継ぎ書を作成」ボタン、または左メニューの「引き継ぎ書」をクリックします。',
      },
      {
        step: '2',
        title: '対象物件を選ぶ',
      ...
      },
      {
        step: '3',
        title: 'AIが自動生成',
        body: '「引き継ぎ書を生成」ボタンを押すと、AIが物件の全情報を整理して引き継ぎ書を作成します。過去の案件履歴・注意事項・次のアクションまで自動でまとめます。',
      },
      {
        step: '4',
        title: '確認・修正してPDF出力',
        body: '生成された内容を確認し、追記が必要な情報を加えます。「PDF出力」で印刷・保存できます。新担当者と共有してください。',
    ...
    steps: [
      {
        step: '1',
        title: '設定を開く',
        body: '左メニュー下部の「設定」→「ユーザー管理」を開きます。現在登録されているスタッフの一覧が表示されます。',
      },
      {
        step: '2',
        title: '招待メールを送る',
        body: '「ユーザーを招待」ボタンを押し、スタッフのメールアドレスと権限（一般・閲覧のみ）を選択して送信します。スタッフにメールが届きます。',
      },
      {
        step: '3',
        title: 'スタッフがアカウントを作成',
        body: 'スタッフは届いたメールのリンクからサインアップします。パスワードを設定するだけで、御社のデータにアクセスできるようになります。',
