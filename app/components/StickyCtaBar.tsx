...
export default function StickyCtaBar() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-50 border-t border-[#d2d2d7]/60 bg-white/95 backdrop-blur-md px-4 py-3 shadow-[0_-4px_24px_rgba(0,0,0,0.08)]"
    ...
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <Link
            href="#contact"
            className="hidden text-[13px] text-[#0071e3] hover:underline sm:inline whitespace-nowrap"
          >
            導入前に質問する
          </Link>
          <Link
