...
export const posts: Post[] = [
  ...
  },
  {
    ...
    title: 'マンション住民クレームの対応方法｜騒音・ペット・駐車場トラブル別',
    description: '騒音・ペット・共用部分など住民クレームの種類別対応方法と、こじれさせない初動のポイントを解説。対応履歴の記録管理で担当者交代後も一貫した対応を維持します。',
    publishedAt: '2026-07-17',
    category: '住民対応',
  ...
  {
    slug: 'sokai-giketsu',
    title: '管理組合総会での議決方法｜普通決議・特別決議の違いと定足数',
    description: '管理組合総会の議決要件（普通決議・特別決議）、定足数、議決権行使書・委任状の扱いを解説。総会準備スケジュールとよくあるトラブルへの対処法も紹介します。',
    publishedAt: '2026-07-17',
    category: '総会・理事会',
  ...
  {
    slug: 'riji-yakuwari',
    title: '管理組合の役員（理事長・副理事長・理事・監事）の役割と責任',
    description: '管理組合の理事長・副理事長・理事・監事それぞれの役割・責任・権限を解説。フロント担当者が役員と良好な関係を築くためのポイントも紹介します。',
    publishedAt: '2026-07-17',
    category: '管理組合',
