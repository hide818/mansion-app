      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          <button
            type="submit"
            disabled={!canSubmit}
            className="inline-flex min-w-[64px] items-center justify-center rounded-xl bg-slate-900 px-5 py-3 text-sm font-medium !text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:!text-slate-500"
          >
            {loading ? '作成中...' : '議事録の作成'}
          </button>
        </div>
                ...
                {currentEditingRecordId ? (
                  <>
                    <button
                      ...
                      className="inline-flex min-w-[64px] items-center justify-center rounded-xl bg-slate-900 px-4 py-2 text-sm font-medium !text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:bg-slate-300 disabled:!text-slate-500"
                    >
