...
export default async function DocumentAgendaPage({ params }: PageProps) {
  ...
  const text = buildAgendaDraft(data)
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="rounded-2xl border border-blue-100 bg-blue-50 p-4">
        <p className="text-sm font-semibold text-blue-900">
          対応機能：
          議案書作成機能 / 議案書ドラフト生成 / コピペ用テキスト出力
        </p>
      </div>

      <CopyGeneratedText title="議案書ドラフト" text={text} />
    </div>
  )
}